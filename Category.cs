    ...
    public partial class Category : Form
    {
            ...
            private void cataddbtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Con.Open();
                    String query = "insert into CatTable1 (CatName, Description) values ('" + catname.Text + "','" + description.Text + "')";
        ...
        {
            Con.Open();
            string query = "select * from CatTable1";
        ...
        private void catdelbtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Con.Open();
                    String query = "delete from CatTable1 where CatID=" + catid.Text + "";
                    SqlCommand command = new SqlCommand(query, Con);
                    command.ExecuteNonQuery();
        ...
        private void cateditbtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Con.Open();
                    String query = "update CatTable1 set CatName='" + catname.Text + "', Description='" + description.Text + "'where CatID=" + catid.Text + ";";
                    SqlCommand command = new SqlCommand(query, Con);
                    command.ExecuteNonQuery();
